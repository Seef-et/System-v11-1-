    ...
    async execute(interaction, client) {
     ...
     const embed = new EmbedBuilder()
       ...
       .addFields([
         ...
         { name: 'Shared by:', value: `[@Seef](https://www.instagram.com/seeef_et/?hl=fr)`, inline: true },
          ])
    .setColor(client.mainColor)
        .setFooter({text: `${client.user.tag} | IS: Seef`, iconURL: client.user.displayAvatarURL()})
    ...
    .setTitle('ℹ️ Info Commands (4)')
     .setColor(client.mainColor)
      .addFields([
        ...
        .setFooter({text: `${client.user.tag} | YT: Seef`, iconURL: client.user.displayAvatarURL()})
